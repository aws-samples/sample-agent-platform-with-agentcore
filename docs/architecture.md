...
EventBridge Scheduler → Lambda firing engine, the channel entries (token
webhooks + the private SigV4 service entry for machine callers), AgentCore
